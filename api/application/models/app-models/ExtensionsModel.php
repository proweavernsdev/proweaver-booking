...
class ExtensionsModel extends CI_Model{
    ...
    public function create($post){
        $this->db->insert('book_extensions', $post);
    ...
    public function update($id,$post){
        ...
        $this->db
        ->set($post)
        ->where(array('book_extensions_id' => $id))
        ->update('book_extensions');
