...
export default class DateFunc{
    ...
    get date(){ return this.dateObj.getUTCDate()} 
    get day(){ return this.dateObj.getUTCDay()} 
    get year(){ return this.dateObj.getUTCFullYear()} 
    get hours(){ return this.dateObj.getUTCHours()} 
    get milliseconds(){ return this.dateObj.getUTCMilliseconds()} 
    get minutes(){ return this.dateObj.getUTCMinutes()} 
    get month(){ return this.dateObj.getUTCMonth()} 
    get seconds(){ return this.dateObj.getUTCSeconds()} 
    get time(){ return this.dateObj.getUTCTime()} 
    get timezoneOffset(){ return UTCObj.clientOffset}
    get sql(){ return this.iso.replace('T',' ').match(/[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}/g)[0] }
    
    get iso(){
        return this.dateObj.toISOString()
    }

    setDate(date){ return this.dateObj.setDate(date)} 
    setDay(day){ return this.dateObj.setDay(day)} 
    setYear(year){ return this.dateObj.setFullYear(year)} 
    setHours(hours){ return this.dateObj.setHours(hours)} 
    setMilliseconds(milliseconds){ return this.dateObj.setMilliseconds(milliseconds)} 
    setMinutes(minutes){ return this.dateObj.setMinutes(minutes)} 
    setMonth(month){ return this.dateObj.setMonth(month)} 
    ...
    format(format){
        ...
        const [d,H1,m,s] = [D.replace(/^0/g,''),H.replace(/^0/g,''),M.replace(/^0/g,''),S.replace(/^0/g,'')]
