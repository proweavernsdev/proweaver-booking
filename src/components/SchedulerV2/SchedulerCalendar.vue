...
<!-- editor modal -->
<div class="fixed bg-[rgba(0,0,0,0.5)] w-screen h-screen top-0 left-0 z-[9] flex justify-center items-center" v-if="isModalOpened">
    <div class="bg-white max-w-[600px] w-full rounded-md overflow-hidden">
        <div class="bg-gray-900 text-white py-4 px-3 flex justify-between">
            ...
            <button class="bg-white rounded-full w-[25px] h-[25px] flex justify-center items-center transition hover:scale-105 active:scale-95" @click="isModalOpened = false">
        ...
        <div class="p-3">
            <div class="grid items-center gap-y-2 mb-3" style="grid-template-columns: 150px 1fr;">
                ...
                <div class="flex flex-wrap gap-1 justify-start" v-if="_id == ''">
                    <label class="w-[70px] flex justify-between items-center gap-1 border p-1 rounded-md">Sun <input :checked="_repeatDays.includes(0)" @click="queScheduleFuncs.repeatDays(0)" type="checkbox" class="mt-[2px]"></label>
                    <label class="w-[70px] flex justify-between items-center gap-1 border p-1 rounded-md">Mon <input :checked="_repeatDays.includes(1)" @click="queScheduleFuncs.repeatDays(1)" type="checkbox" class="mt-[2px]"></label>
                    <label class="w-[70px] flex justify-between items-center gap-1 border p-1 rounded-md">Tue <input :checked="_repeatDays.includes(2)" @click="queScheduleFuncs.repeatDays(2)" type="checkbox" class="mt-[2px]"></label>
                    <label class="w-[70px] flex justify-between items-center gap-1 border p-1 rounded-md">Wed <input :checked="_repeatDays.includes(3)" @click="queScheduleFuncs.repeatDays(3)" type="checkbox" class="mt-[2px]"></label>
                    <label class="w-[70px] flex justify-between items-center gap-1 border p-1 rounded-md">Thu <input :checked="_repeatDays.includes(4)" @click="queScheduleFuncs.repeatDays(4)" type="checkbox" class="mt-[2px]"></label>
                    <label class="w-[70px] flex justify-between items-center gap-1 border p-1 rounded-md">Fri <input :checked="_repeatDays.includes(5)" @click="queScheduleFuncs.repeatDays(5)" type="checkbox" class="mt-[2px]"></label>
                    <label class="w-[70px] flex justify-between items-center gap-1 border p-1 rounded-md">Sat <input :checked="_repeatDays.includes(6)" @click="queScheduleFuncs.repeatDays(6)" type="checkbox" class="mt-[2px]"></label>
                </div>
                <label>Service</label>
                ...
                <div class="flex gap-2 flex-wrap">
                    <button class="transition bg-[#8b9933] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#8b9933' }" @click="_color = '#8b9933'"></button>
                    <button class="transition bg-[#6d9933] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#6d9933' }" @click="_color = '#6d9933'"></button>
                    <button class="transition bg-[#4e9933] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#4e9933' }" @click="_color = '#4e9933'"></button>
                    <button class="transition bg-[#339936] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#339936' }" @click="_color = '#339936'"></button>
                    <button class="transition bg-[#339955] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#339955' }" @click="_color = '#339955'"></button>
                    <button class="transition bg-[#339974] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#339974' }" @click="_color = '#339974'"></button>
                    <button class="transition bg-[#339992] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#339992' }" @click="_color = '#339992'"></button>
                    <button class="transition bg-[#338199] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#338199' }" @click="_color = '#338199'"></button>
                    <button class="transition bg-[#336399] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#336399' }" @click="_color = '#336399'"></button>
                    <button class="transition bg-[#334499] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#334499' }" @click="_color = '#334499'"></button>
                    <button class="transition bg-[#413399] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#413399' }" @click="_color = '#413399'"></button>
                    <button class="transition bg-[#5f3399] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#5f3399' }" @click="_color = '#5f3399'"></button>
                    <button class="transition bg-[#7e3399] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#7e3399' }" @click="_color = '#7e3399'"></button>
                    <button class="transition bg-[#993396] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#993396' }" @click="_color = '#993396'"></button>
                    <button class="transition bg-[#993377] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#993377' }" @click="_color = '#993377'"></button>
                    <button class="transition bg-[#993358] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#993358' }" @click="_color = '#993358'"></button>
                    <button class="transition bg-[#99333a] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#99333a' }" @click="_color = '#99333a'"></button>
                    <button class="transition bg-[#994b33] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#994b33' }" @click="_color = '#994b33'"></button>
                    <button class="transition bg-[#996933] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#996933' }" @click="_color = '#996933'"></button>
                    <button class="transition bg-[#998833] w-[30px] h-[20px]" :class="{'border-2 border-solid border-gray-900':_color == '#998833' }" @click="_color = '#998833'"></button>
                </div>
                <label>Max Bookings</label>
                <input type="number" class="bg-gray-100 p-1" min="1" v-model="_max_appointments">
                
                <label>Special Label</label>
                <select class="bg-gray-100 p-1" min="1" :value="_special_status" @change="_special_status = $event.target.value">
                    <option value="0">None</option>
                    <option value="1">Reserved</option>
                    <option value="2">Closed</option>
                </select>
                <label v-if="_special_status == '1'">Appointee</label>
                <input v-if="_special_status == '1'" class="bg-gray-100 p-1" v-model="_appointee" placeholder="Name of Reservation Holder">
            ...
            <div v-if="_id==''" class="mb-4">
                ...
                <div class="max-h-[150px] overflow-y-auto">
                    <div class="grid mb-2 gap-1" style="grid-template-columns: 1fr 15px 1fr 30px;" v-for="ts,i in _timeSlots">
                        ...
                        <button class="w-[30px] h-[30px] bg-red-500 text-white flex justify-center items-center rounded-md transition hover:scale-105 active:scale-95" @click="_timeSlots.splice(i,1)" v-if="_timeSlots.length > 1">
                            <i v-html="icons.close"></i>
                        </button>
                    </div>
                </div>
                <button class="flex gap-1 items-center" @click="_timeSlots.push({time_start:'00:00',time_end:'01:00'})"><i v-html="icons.add"></i> Add Timeslot</button>
            </div>
            <div v-if="errorMsgModal != ''" v-html="errorMsgModal" class="bg-red-100 p-2 mb-2 text-center text-red-900"></div>

            <div class="flex justify-end gap-1">
                <button class="bg-green-700 text-white rounded-md p-1 block transition hover:scale-105 active:scale-95" @click="queScheduleFuncs.setSchedule()">Save Schedule</button>
                <button v-if="queSchedule.id != ''" class="bg-red-700 text-white rounded-md p-1 block transition hover:scale-105 active:scale-95" @click="queScheduleFuncs.deleteSchedule(queSchedule.id)">Delete Schedule</button>
            </div>
...
<div class="border-b border-dashed border-gray-400 pb-4 mb-4 flex justify-between gap-1 items-center">
    <div class="flex items-stretch">
        <button @click="nextMonths(-1)" class="bg-gray-900 text-white py-1 px-2 rounded-tl-full rounded-bl-full transition hover:scale-105 active:scale-95">
        ...
        <button @click="nextMonths(1)" class="bg-gray-900 text-white py-1 px-2 rounded-tr-full rounded-br-full transition hover:scale-105 active:scale-95">
    ...
    <div>
        <button class="hover:scale-105 transition active:scale-95 bg-green-700 py-1 px-3 rounded-full text-white" @click="saveChanges">Save Changes</button>
    </div>
...
<div class="grid grid-cols-7 gap-2"> 
    ...
    <div class="p-2  border-gray-300 text-gray-700 border-t" v-for="cb,i in calendarBoxes" :key="cb.date" :class="{'border-solid':cb.isCurrentMonth,'border-dotted text-stone-600':!cb.isCurrentMonth}" @click="cb.onclick(cb.date)">
        <h3 class="text-2xl mb-3">{{ cb.dateNum }}</h3>

        <div class="mb-2" v-for="ds,i in daySchedules(cb.date)" @click="queScheduleFuncs.set(ds)">
            <div v-if="i < 2 || (showMoreScheds && dateAdjusted(cb.date + ' 00:00:00').getTime() == dateAdjusted(qd.y,qd.m,qd.d).getTime()) ">
                <h4 class="font-semibold text-md max-w-full">
                    <span class="">{{ds.service}}</span>
                    <i class="ml-2 w-[10px] h-[10px] rounded-full mt-1 inline-block" :style="{background:ds.color}"></i>
                </h4>
                <p class="text-sm"> 
        ...
        <button @click="queScheduleFuncs.set();_date=cb.date;_date_end=cb.date;" class="flex items-center gap-2 border-t mt-3 pt-1 text-sm w-full" v-if="dateAdjusted(cb.date + ' 00:00:00').getTime() == dateAdjusted(qd.y,qd.m,qd.d).getTime()"><i class="font-bold pb-1">+</i> Add Schedule</button>
